...
saveRDS(query,"out/object/Azimuth_humancortexref_harmonyMartina.rds")
...
meta_query <- read_tsv("out/table/data.combined_NOT_annotated_fix_normalized_meta_AzimuthHumanCortexRef_resolution_DoubletSinglet_harmonyMartina.tsv") %>%
...
meta_query %>%
  ...
  theme(axis.text.x = element_text(hjust = 1,angle = 45)) + 
  geom_hline(yintercept = 0.75,col="red")
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_class_score_075_harmonyMartina.pdf",height = 4,width = 2)
...
meta_query %>%
  ...
  geom_hline(yintercept = 0.75,col="red")
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_cluster_score_075_harmonyMartina.pdf",height = 4,width = 6)
...
ggplot(label= TRUE)+
  ...
  guides(colour = guide_legend(override.aes = list(size=5))) +
  # labs(color= "Clusters") +
  ggrepel::geom_text_repel(data = data_query_avg,aes(x = UMAP_1,y = UMAP_2,label = robust_score_subclass),col="black")+theme_bw()+facet_grid(~group_martina)+
  theme(strip.background = element_blank(), 
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_subclass_split_UMAP_075_queryMartina_harmonyMartina.pdf",width = 8,height = 3)

# costume visualization
UMAP_ref <- read_tsv("out/table/azimuth_humancortex_CoordUMAP.tsv")
UMAP_ref2 <- read_tsv("out/table/data.combined_NOT_annotated_fix_normalized_CoordUMAP_AzimuthHumanCortexRef_resolution_DoubletSinglet_harmonyMartina.tsv")
...
ggsave("out/image/human_motorcortexv1.0.0_subclass_alt.pdf",width = 8,height = 6)
...
ggsave("out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_075_subclass_harmonyMartina_alt.pdf",width = 8,height = 6)
...
ggplot(label= TRUE)+
  ...
  guides(colour = guide_legend(override.aes = list(size=5),ncol=1)) +
  # labs(color= "Clusters") +
  # ggrepel::geom_text_repel(data = data_ref_avg2subclass,aes(x = UMAP_1,y = UMAP_2,label = predicted.subclass),col="black")+
  theme_cowplot()
ggsave("out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_075_subclass_harmonyMartina_alt_noLabel.pdf",width = 8,height = 6)
...
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_subclass_score_050_harmonyMartina.pdf",height = 4,width = 4)
...
meta_query %>%
  ...
  ggridges::geom_density_ridges()+
  theme_bw() + 
  geom_vline(xintercept = 0.50,col="red",linetype="dashed")
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_subclass_score_ridges_050_harmonyMartina.pdf",height = 5,width = 4)
...
meta_query %>%
  ...
  theme(axis.text.x = element_text(hjust = 1,angle = 45)) + 
  geom_hline(yintercept = 0.50,col="red")
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_class_score_050_harmonyMartina.pdf",height = 4,width = 2)
...
meta_query %>%
  ...
  theme(axis.text.x = element_text(hjust = 1,angle = 45),
        plot.margin = margin(0.5, 0.5, 0.5, 2, "cm")) + 
  geom_hline(yintercept = 0.50,col="red")
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_cluster_score_050_harmonyMartina.pdf",height = 4,width = 6)
...
pdf("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_subclass_heatmapFilter_050_harmonyMartina.pdf",height = 3,width = 5)
Heatmap(prop_table_subclass_filter,
        name = "prop", 
        column_title = "subclass score high confidence",
        cluster_rows = T,cluster_columns = T,col = viridis::turbo(10))
...
ggplot(label= TRUE)+
  ...
  # labs(color= "Clusters") +
  ggrepel::geom_text_repel(data = data_query_avg,aes(x = UMAP_1,y = UMAP_2,label = robust_score_subclass),col="black")+theme_bw()
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_subclass_UMAP_050_harmonyMartina.pdf",width = 5,height = 3)
...
ggplot(label= TRUE)+
  ...
  theme(strip.background = element_blank(), 
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_subclass_split_UMAP_050_harmonyMartina.pdf",width = 20,height = 3)
...
ggplot(label= TRUE)+
  ...
  theme(strip.background = element_blank(), 
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("out/image/data.combined_annotated_norm_fix_resolution_DoubletSinglet_human_motorcortexv1.0.0_subclass_split_UMAP_050_queryMartina_harmonyMartina.pdf",width = 8,height = 3)
...
ggsave("out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_050_harmonyMartina.pdf",width = 9,height = 6)
...
ggplot(label= TRUE)+
  ...
  guides(colour = guide_legend(override.aes = list(size=5),ncol=2)) +
  # labs(color= "Clusters") +
  ggrepel::geom_text_repel(data = data_ref_avg2,aes(x = UMAP_1,y = UMAP_2,label = seurat_clusters),col="black",max.overlaps = 25)+theme_bw()+facet_wrap(~orig.ident)+theme(strip.background = element_blank())
ggsave("out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_050_split_harmonyMartina.pdf",width = 20,height = 22)
...
ggplot(label= TRUE)+
  ...
  # labs(color= "Clusters") +
  ggrepel::geom_text_repel(data = data_ref_avg2subclass,aes(x = UMAP_1,y = UMAP_2,label = predicted.subclass),col="black")+theme_bw()
ggsave("out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_050_subclass_harmonyMartina.pdf",width = 8,height = 6)
...
ggplot(label= TRUE)+
  ...
  # labs(color= "Clusters") +
  ggrepel::geom_text_repel(data = data_ref_avg2subclass,aes(x = UMAP_1,y = UMAP_2,label = predicted.subclass),col="black")+theme_cowplot()
ggsave("out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_050_subclass_harmonyMartina_alt.pdf",width = 8,height = 6)
...
ggplot(label= TRUE)+
  ...
  # labs(color= "Clusters") +
  ggrepel::geom_text_repel(data = data_ref_avg2subclass,aes(x = UMAP_1,y = UMAP_2,label = predicted.subclass),col="black")+theme_bw()+facet_wrap(~orig.ident)+theme(strip.background = element_blank())
ggsave("out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_050_subclass_split_harmonyMartina.pdf",width = 20,height = 21)
